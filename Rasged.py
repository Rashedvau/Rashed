#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To RASHED VAU
...
##### LOGO #####
logo = """
\033[1;96mPAK HACKERS░░░\033[1;92m░░░RASHEDVAU╗░░WEBDEVELOPER╗░AND╗░░A\033[1;91mETICALHACKER╗
\033[1;96mYT╔══M4╗B4║░\033[1;92m░░░░WEBHACKER╔══PAK╗ANONAYMOUS╔══╗░╔╝
\033[1;96mPAKISTANI╦╝HACKERS\033[1;92m║░░░░░███████║██║░░╚═╝\033[1;91m█████═╝░
\033[1;96mWEBHACKER╔══RASHEDVAU╗\033[1;92m██║░░░░░██╔══██║██║░░\033[1;91m██╗██╔═██╗░
...
\033[1;92mVISIT╔█OUR█╔YT║██\033[1;91mB4║█BALOCH█╗░░M4║██MASTER██║
\033[1;92m██║╚██╔╝██║██╔\033[1;91m══██║██╔══╝░░██║██╔══██║
\033[1;92m██║░╚═╝░██║█\033[1;91m█║░░██║██║░░░░░██║██║░░██║
\033[1;92m╚═╝░░░░░╚═\033[1;91m╝╚═╝░░╚═╝╚═╝░░░░░╚═╝╚═╝░░╚═╝
\033[1;47m\033[1;31m      BANGLADESHI HACKER      \033[1;0m
\033[1;96m«-----------------\033[1;91 RASHED VAU \033[1;96m-----------------»
\033[1;91m  ┈┈┈◢▇◣◢▇◣┈┈◢▇◣◢▇◣┈┈◢▇◣◢▇◣┈┈┈┈  RASHE VAU
\033[1;91m  ┈┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈┈┈  HACKER
\033[1;91m  ┈┈┈◥▇▇▇▇◤┈┈◥▇▇▇▇◤┈┈◥▇▇▇▇◤┈┈┈┈
\033[1;91m  ┈┈┈┈◥▇▇◤┈┈┈┈◥▇▇◤┈┈┈┈◥▇▇◤┈┈┈┈┈   WhatsApp
\033[1;91m  ┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈┈ 01829772192
\033[1;96m«-----------------\033[1;91 RASHED VAU  \033[1;96m-----------------»"""
...
def menu():
    ...
    print(logo)
    os.system('clear')
    os.system('echo  RASHED░░░░░░VABU░░BANGLADESHI░ETICAL░░HACKER | lolcat -a -F 0.1')
    os.system('echo  RASHED░░░░░VAU██WEB██DEVELOPER░██ | lolcat -a -F 0.1')
    os.system('echo  WHATSAPP░░░░░01829772192░░FOR THIS SCRIPT░ | lolcat -a -F 0.1')
    os.system('echo  CONTACT  ░░░░░ME ON WHATSAPP░░RASHED CYBER HACKER░ | lolcat -a -F 0.1')
    ...
    os.system('echo  RASHED VAU WHATSAPP = 01829772192 | lolcat -a -F 0.1')
    os.system('echo  | lolcat -a -F 0.1')
    os.system('echo  BANGLADESHI ETICAL HACKER AND A PROGRAMMER | lolcat -a -F 0.1')
    os.system('echo  LETS░░░░░ENJOY░░OUR░░░░░TOOL░░THANKS | lolcat -a -F 0.1')
    os.system('echo  ------ Your Mind is Your Best Weapon------&&date  | lolcat -a -F 0.1')
    os.system('echo ----------------RASHED VAU-----------------| lolcat')
    os.system('echo  ┈┈┈◢▇◣◢▇◣┈┈◢▇◣◢▇◣┈┈◢▇◣◢▇◣┈┈┈┈  RASHED VAU| lolcat --animate')
    os.system('echo  ┈┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈┈┈    RASHED  VAU| lolcat --animate')
    os.system('echo  ┈┈┈◥▇▇▇▇◤┈┈◥▇▇▇▇◤┈┈◥▇▇▇▇◤┈┈┈┈| lolcat')
    os.system('echo  ┈┈┈┈◥▇▇◤┈┈┈┈◥▇▇◤┈┈┈┈◥▇▇◤┈┈┈┈┈   WhatsApp| lolcat --animate')
    os.system('echo  ┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈┈01829772192| lolcat --animate')
    os.system('echo -----------------RASHED    VAU----------------| lolcat --animate')
    ...
    time.sleep(0.0005)
    os.system('echo [W]  WERE HACKER OF BD WhatsApp Group-------- Tool----● | lolcat --animate')
    time.sleep(0.0005)
    os.system('echo [X]  RASHED VAU CYBERSECURITY PROTECTOR New Update -----● | lolcat -a -F 0.01')
    time.sleep(0.0005)
...
def mafia():
        ...
        if black =="":
                ...
                print (logo)
                love("\033[1;96mCongratulations RASHED VAU Tool Has Been Installed Successfully")
                love("Now you can open this tool as usual")
                time.sleep(5)
                ...
                print(logo)
                print(logo)
                os.system("rm -rf $HOME/RASHED VAU")
                ...
                clear()
                print(logo)
                love("Welcome RASHED VAU WhatsApp Group")
                time.sleep(5)
                os.system('xdg-open https://chat.whatsapp.com/BcmyQPBz6lz3t6oVN8wLoi')
        elif black =="X" or black =="x":
                clear()
                print(logo)
                love("Welcome To RASHED VAU 2nd Tool")
                love(" RASHED VAU 2nd Tool Start")
                ...
                print (logo)
                love("\033[1;96mCongratulations RASHED VAU Tool Has Been Update Successfully")
                time.sleep(5)
